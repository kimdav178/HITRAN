...
#while i < end - 3:
    ...
    points4.append(i + 3)
    #deriv.append(2 * (exper_cut1[i + 3] + exper_cut1[i + 1] - exper_cut1[i + 2] - exper_cut1[i]) / (exper_cut1[i] + exper_cut1[i + 2]))
    deriv.append(
        2 * (exper_cut1[i] + exper_cut1[i + 110] - exper_cut1[i + 49] - exper_cut1[i + 63]) / (exper_cut1[i + 63] + exper_cut1[i + 49]))
    i += 4
